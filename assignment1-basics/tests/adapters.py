...
def run_multihead_self_attention(
    ...
    """
    attention = CausalMultiHeadAttention(d_model, num_heads)
...
def run_multihead_self_attention_with_rope(
    ...
    Returns:
        ...
        implementation with the given QKV projection weights and input features.
    """
    attention = CausalMultiHeadAttention(d_model, num_heads, max_seq_len=max_seq_len, theta=theta)
    attention.load_state_dict(
        {
            "q_proj.weight": q_proj_weight,
            "k_proj.weight": k_proj_weight,
...
def run_transformer_block(
    ...
    return block.forward(in_features, token_positions=token_positions)
...
def run_transformer_lm(
    ...
    """
    lm = Transformer(d_model, num_heads, d_ff, rope_theta, vocab_size, context_length, num_layers)
